...
AI-powered web application that accepts a selfie and returns real-time demographic predictions including age, gender, and ethnicity. Integrates a facial-recognition API with async state management to handle concurrent processing without UI blocking.
